...
// To create a service
serviceRoute.post("/create-service", isAuth, attachCurrentUser, async (req, res) => {
  try {
...
// All Services 
serviceRoute.get("/my-services", isAuth, attachCurrentUser, async (req, res) => {
  try {
...
//Update a service
serviceRoute.put("/edit/:idService", isAuth, attachCurrentUser, async (req, res) => {
  try {
